...
import com.hex.ailowcode.model.enums.UserRoleEnum;
...
import com.hex.ailowcode.mapper.UserMapper;
...
import static com.hex.ailowcode.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public QueryWrapper getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        return QueryWrapper.create().eq("id", id).eq("userRole", userRole).like("userAccount", userAccount)
                .like("userName", userName).like("userProfile", userProfile)
